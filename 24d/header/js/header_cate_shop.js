...
/*
  ...
  $('#category_wrap').on('mouseenter', function () {
    clearTimeout(cate1Timer);
    $('.scroll_cate').stop(true, true).fadeIn(300);
  });

  $('#category_wrap').on('mouseleave', function () {
    cate1Timer = setTimeout(function () {
      $('.scroll_cate').stop(true, true).fadeOut(300);
      $('.cate2_ul').stop(true, true).fadeOut(300);
    }, 100);
  });
  ...
  $('.cate1_li').on('mouseenter', function () {
    clearTimeout(cate2Timer);
    $('.cate2_ul').stop(true, true).fadeOut(300);
    $(this).find('.cate2_ul').stop(true, true).fadeIn(300, function () {
  ...
  $('.cate2_li').on('mouseenter', function () {
    clearTimeout(cate3Timer);
    $('.cate3_ul').stop(true, true).fadeOut(300);
    $(this).find('.cate3_ul').stop(true, true).fadeIn(300, function () {
      $(this).css('display', 'flex');
    });
  });
  ...
  $('.cate3_li').on('mouseenter', function () {
    clearTimeout(cate4Timer);
    $('.cate4_ul').stop(true, true).fadeOut(300);
    $(this).find('.cate4_ul').stop(true, true).fadeIn(300, function () {
      $(this).css('display', 'flex');
    });
  });
...
$('#category_title').on('click', function () {
  const $scrollCate = $('#category_wrap > .scroll_cate');

  if ($scrollCate.is(':visible')) {
    $scrollCate.stop(true, true).slideUp(300);
  } else {
    $scrollCate.stop(true, true).slideDown(300);
  }
});
